...
default_cfgs = {
    ...
    "vit_deit_tiny_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-a1311bcf.pth"),
    "vit_deit_small_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_small_patch16_224-cd65a155.pth"),
...
class Attention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if mask is not None:
            attn = differentiable_masked_softmax(attn, mask)
            # # original softmax with mask
            # mask = mask.bool()
            # attn = attn.masked_fill(~mask[:, None, None, :], -100000.0)
        else:
